...
var YourGameResultService = (function () {
    function YourGameResultService() {
    }
    YourGameResultService.prototype.checkResult = function (game) {
        var isTie = true;
        var hasWinner = false;
        var whoWon = Marker.Empty;
        ...
        if (!hasWinner && !isTie) {
            //Diagonals
            if (game.board[1][1] == game.board[0][0] && game.board[1][1] == game.board[2][2] || game.board[1][1] == game.board[0][2] && game.board[1][1] == game.board[2][0]) {
    ...
    return YourGameResultService;
})();
//# sourceMappingURL=YourGameResultService.js.map